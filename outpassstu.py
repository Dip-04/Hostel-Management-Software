...
class outpassstu:
    ...
    def __init__(self, root2):
        ...
        self.fromm = StringVar()
        self.to = StringVar()
        self.reason = StringVar()
        self.var_time = StringVar()
        self.var_date = StringVar()
        self.pmob = StringVar()
        self.pmail = StringVar()


        l = Label(self.root2, bd=10, relief=RIDGE, text="OUT-PASS", fg='YELLOW', bg='black',
        ...
        Label(labelframe, text="Room No: ", font=('arial', 10, 'bold'), pady=6, padx=2, bg="sky blue").grid(row=4, column=0,
                                                                                                              sticky=W)
        nen = ttk.Entry(labelframe, font=('arial', 10, 'bold'), width=25,textvariable=self.roomno)
        nen.grid(row=4, column=1)
        Label(labelframe, text="Date from ", font=('arial', 10, 'bold'), pady=6, padx=2, bg="sky blue").grid(row=5, column=0,
                                                                                                             sticky=W)
        nen = ttk.Entry(labelframe, font=('arial', 10, 'bold'), width=25,textvariable=self.fromm)
        nen.grid(row=5, column=1)
        Label(labelframe, text=" to ", font=('arial', 10, 'bold'), pady=6, padx=2, bg="sky blue").grid(row=5,
                                                                                                                column=2,
                                                                                                                sticky=W)
        nen = ttk.Entry(labelframe, font=('arial', 10, 'bold'), width=20, textvariable=self.to)
        nen.place(x=360,y=177)
        Label(labelframe, text="Reason: ", font=('arial', 10, 'bold'), pady=6, padx=2, bg="sky blue").grid(row=7, column=0,
                                                                                                         sticky=W)
        nen = ttk.Entry(labelframe, font=('arial', 10, 'bold'), width=25,textvariable=self.reason)
        ...
        Label(labelframe, text="Mobile No: ", font=('arial', 10, 'bold'), pady=6, padx=2, bg="sky blue").grid(row=10,
                                                                                                              column=0,
                                                                                                              sticky=W)
        nen = ttk.Entry(labelframe, font=('arial', 10, 'bold'), width=25, textvariable=self.pmob)
        nen.grid(row=10, column=1)
        Label(labelframe, text="Email Id: ", font=('arial', 10, 'bold'), pady=6, padx=2, bg="sky blue").grid(row=11,
                                                                                                             column=0,
                                                                                                             sticky=W)
        nen = ttk.Entry(labelframe, font=('arial', 10, 'bold'), width=25, textvariable=self.pmail)
        nen.grid(row=11, column=1)
    ...
    def Add_data(self):
        if self.n.get() == "":
            ...
            try:
                ...
                query = "insert into outpass (FIRST_NAME,LAST_NAME,MAIL,MOBILE_NO,ROOM_NO,DFROM,TOD,REASON,PARENT_MOB,PARENT_MAIL,DATE,TIME) values (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
                arg = (self.n.get(), self.ln.get(), self.mid.get(), self.mno.get(), self.roomno.get(), self.fromm.get(),
                       self.to.get(), self.reason.get(), self.pmob.get(), self.pmail.get(),self.var_date.get(),self.var_time.get())
                my_cusror.execute(query, arg)
                conn.commit()
                conn.close()
                messagebox.showinfo('Outpass ', f'APPLY SUCCUSEFULLY \n______________________________________________________________\n', parent=self.root2)
