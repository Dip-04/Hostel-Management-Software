...
class Admin:
 ...
 def __init__(self, root1):
  ...
  Button(btfram,text="Room",font=('times new roman',14,'bold'),width=22,bg='black',fg='gold',bd=0,relief=RIDGE,cursor='hand1',command=lambda :self.addroom()).grid(row=2,column=0,pady=1)
  ...
  Button(btfram,text="Employee",font=('times new roman',14,'bold'),width=22,bg='black',fg='gold',bd=0,relief=RIDGE,cursor='hand1',command=lambda :self.emp()).grid(row=4,column=0,pady=1)
  ...
  l = Label(p, bd=4, relief=RIDGE, text="Administrator", fg='red',
